...
class Layer3():
    ...
    def create_route_optimization_prompt(self, route_json, similar_places_by_tags, wish, character_type="friendly_guide"):
        json_format = '''[
        {
            "day": 1,
            "route": [
        ...
        prompt = f"""Ты - помощник по планированию поездки и человек идеально знающий калининградскую область, играющий роль {character_type}. Твоя задача - помочь улучшить предложенный маршрут.
            ОСОБЫЕ ПОЖЕЛАНИЯ ПОЛЬЗОВАТЕЛЯ:
            {wish}
            ...
            'chat done'
            И НИЧЕГО БОЛЕЕ ТОЛЬКО ЭТИ 2 СЛОВА
            ...
            4. Не добавляй никаких пояснений или дополнительного текста к финальному ответу
            ...
            - При выводе финального ответа не добавляй никакого дополнительного текста
